...
script_name = "comparative_zeisel_cns_neurons_correlation_glut_zf_ortho_by_ident_non-tfs_vargenes"
...
to_use = Reduce(intersect, list(obj_int_filt_var, compare_obj_var))
to_use = to_use[!(to_use %in% tfs$external_gene_name)]
