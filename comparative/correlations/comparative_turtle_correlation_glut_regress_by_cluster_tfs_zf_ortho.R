...
script_name = "comparative_turtle_correlation_glut_regress_by_cluster_tfs_zf_ortho"
...
ann_col = compare_md %>% filter(clusters %in% colnames(obj_cor_filt)) %>%
  distinct(clusters, pallial.area, .keep_all=F) %>% 
